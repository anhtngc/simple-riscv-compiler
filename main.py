...
from parsing import parse_instruction, calculate_label_offsets, remove_comments
...
try:
    ...
    print("Successfully converted the instructions to machine codes, click 'output.txt' to see the results!")
